...
var ArtistWhere = struct {
	...
	ID:        whereHelperstring{field: "\"artist\".\"id\""},
	Name:      whereHelpernull_String{field: "\"artist\".\"name\""},
	Biography: whereHelpernull_String{field: "\"artist\".\"biography\""},
	CreatedAt: whereHelpertime_Time{field: "\"artist\".\"createdAt\""},
	UpdatedAt: whereHelpertime_Time{field: "\"artist\".\"updatedAt\""},
}
...
var (
	artistAllColumns            = []string{"id", "name", "biography", "createdAt", "updatedAt"}
	artistColumnsWithoutDefault = []string{}
	artistColumnsWithDefault    = []string{"id", "name", "biography", "createdAt", "updatedAt"}
...
func FindArtist(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Artist, error) {
	artistObj := &Artist{}
...
func ArtistExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
